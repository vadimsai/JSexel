...
export class DomListener {
    ...
    initDomListeners() {
        this.listeners.forEach(listener => {
            ...
            if (!this[method]) { // если нет обработки метода
            ...
            // console.log(this);
            this.$root.on(listener, this[method]) // вызываем on(addEventListener) // this[method].bind(this) теряем контекст Formula, поэтому в Bind передаем контекст this
        })
    }
